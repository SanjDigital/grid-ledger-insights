...
| Data sources | GLASSBOX_26_CLEAN_CYCLES.csv, Airtel Money statements, ESCOM registry (where available) |
...
**For use with:** GLASSBOX_26_CLEAN_CYCLES.csv, CASH_RECONCILIATION_26_CYCLES.md, FACILITY_COVENANT_LANGUAGE_V1_0.md  
